...
header = ['pathway_name','smpdb_id','kegg_map_id','disease_name','omim_id','reference','pubmed_id']
bio_props = []
                ...
                for references in disease.findall('nsstring:references',ns):
                    for reference in references.findall('nsstring:reference',ns):
                        ...
                        try:
                            ...
                            v_pubmed_id = 'unknown'
                        bio_props.append([accession.text,v_pathway_name,v_smpdb_id,v_kegg_map_id,v_disease_name,v_omim_id,v_ref_text,v_pubmed_id])
